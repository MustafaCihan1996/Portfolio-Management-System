...
public class Investment {
    ...
    public static ArrayList<Investment> InvestmentAll = new ArrayList <Investment> ();
    
    public double getGain = 0;

    public double getGetGain() {
        return getGain;
    }

    public void setGetGain(double getGain) {
    ...
    String inputName = "/Users/mustafaasimcihan/NetBeansProjects/program/src/main/java/Investment/input.txt";
